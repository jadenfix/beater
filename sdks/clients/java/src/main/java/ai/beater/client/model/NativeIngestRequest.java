...
@JsonPropertyOrder({
  ...
  NativeIngestRequest.JSON_PROPERTY_SAMPLING_WEIGHT,
...
public class NativeIngestRequest {
  ...
  public NativeIngestRequest samplingWeight(@javax.annotation.Nullable Double samplingWeight) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, nativeIngestRequest.attributes) &&
        ...
        equalsNullable(this.samplingWeight, nativeIngestRequest.samplingWeight) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attributes, hashCodeNullable(authContext), hashCodeNullable(cost), hashCodeNullable(endTime), idempotencyKey, hashCodeNullable(input), kind, hashCodeNullable(model), name, hashCodeNullable(output), parentSpanId, redactionClass, hashCodeNullable(samplingWeight), scope, seq, spanId, hashCodeNullable(startTime), status, hashCodeNullable(tokens), traceId);
  }
