...
std::shared_ptr<RollupEstimate> Page_RunSummary_items_inner::getTotalCostEstimateMicros() const
{
    return m_Total_cost_estimate_micros;
}


void Page_RunSummary_items_inner::setTotalCostEstimateMicros(const std::shared_ptr<RollupEstimate>& value)
{
    m_Total_cost_estimate_micros = value;
    m_Total_cost_estimate_microsIsSet = true;
}

bool Page_RunSummary_items_inner::totalCostEstimateMicrosIsSet() const
{
    return m_Total_cost_estimate_microsIsSet;
}

void Page_RunSummary_items_inner::unsetTotal_cost_estimate_micros()
{
    m_Total_cost_estimate_microsIsSet = false;
}
