...
class HealthApi
{
     ...
     * @return \Beater\Client\Model\HealthResponse
     */
     ...
     * @throws \Beater\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Beater\Client\Model\HealthResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function healthWithHttpInfo(string $contentType = self::contentTypes['health'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Beater\Client\Model\HealthResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Beater\Client\Model\HealthResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Beater\Client\Model\HealthResponse', []),
            ...
            $returnType = '\Beater\Client\Model\HealthResponse';
