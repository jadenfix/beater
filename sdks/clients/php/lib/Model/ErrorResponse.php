...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param int $status HTTP status code, duplicated in the body for convenience.
     *
     * @return self
     */
    public function setStatus($status)
    {
        ...
        if (($status < 0)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ErrorResponse., must be bigger than or equal to 0.');
        }
