...
/**
 * SubmitReviewAnnotationHttpRequest Class Doc Comment
 *
 * @category Class
 * @package  Beater\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitReviewAnnotationHttpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitReviewAnnotationHttpRequest';
    ...
    */
     ...
     * Sets annotation_id
     *
     * @param string|null $annotation_id annotation_id
     *
     * @return self
     */
    public function setAnnotationId($annotation_id)
    {
        if (is_null($annotation_id)) {
            array_push($this->openAPINullablesSetToNull, 'annotation_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('annotation_id', $nullablesSetToNull);
            if ($index !== FALSE) {
