...
/**
 * InvokeConnectorRequest Class Doc Comment
 *
 * @category Class
 * @package  Beater\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvokeConnectorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvokeConnectorRequest';
    ...
    */
     ...
     * Sets arguments
     *
     * @param object|null $arguments Arguments object matching the tool's input schema.
     *
     * @return self
     */
     ...
     * Sets tool
     *
     * @param string $tool Tool slug to execute (e.g. `GITHUB_CREATE_AN_ISSUE`).
     *
     * @return self
     */
