...
/**
 * PromptVersion Class Doc Comment
 *
 * @category Class
 * @package  Beater\Client
 * @author   OpenAPI Generator team
 ...
 */
class PromptVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromptVersion';
    ...
    protected static $openAPITypes = [
        'metadata' => '\Beater\Client\Model\PromptVersionMetadata',
        'project_id' => 'string',
        'prompt_id' => 'string',
        'template' => '\Beater\Client\Model\PromptTemplate',
        'tenant_id' => 'string',
        'version_id' => 'string',
        'version_number' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['version_number'] < 0)) {
            $invalidProperties[] = "invalid value for 'version_number', must be bigger than or equal to 0.";
        }
     ...
     * Gets metadata
     *
     * @return \Beater\Client\Model\PromptVersionMetadata
     */
     ...
     * Sets metadata
     *
     * @param \Beater\Client\Model\PromptVersionMetadata $metadata metadata
     *
     * @return self
     */
     ...
     * Sets prompt_id
     *
     * @param string $prompt_id prompt_id
     *
     * @return self
     */
     ...
     * Gets template
     *
     * @return \Beater\Client\Model\PromptTemplate
     */
     ...
     * Sets template
     *
     * @param \Beater\Client\Model\PromptTemplate $template template
     *
     * @return self
     */
    ...
    public function setVersionNumber($version_number)
    {
        ...
        if (($version_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $version_number when calling PromptVersion., must be bigger than or equal to 0.');
        }
