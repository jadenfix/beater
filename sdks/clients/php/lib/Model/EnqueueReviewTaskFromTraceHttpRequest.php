...
/**
 * EnqueueReviewTaskFromTraceHttpRequest Class Doc Comment
 *
 * @category Class
 * @package  Beater\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnqueueReviewTaskFromTraceHttpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnqueueReviewTaskFromTraceHttpRequest';
    ...
    */
    ...
    public function setDatasetCaseId($dataset_case_id)
    {
        if (is_null($dataset_case_id)) {
            array_push($this->openAPINullablesSetToNull, 'dataset_case_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dataset_case_id', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($span_id)) {
            array_push($this->openAPINullablesSetToNull, 'span_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('span_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
