...
```php
runCalibration($tenant_id, $project_id, $dataset_id, $version_id, $run_calibration_http_request, $authorization, $x_beater_api_key, $x_beater_project_id, $x_beater_environment_id): \Beater\Client\Model\CalibrationReport
```
...
$apiInstance = new Beater\Client\Api\CalibrationsApi(
...
$run_calibration_http_request = new \Beater\Client\Model\RunCalibrationHttpRequest(); // \Beater\Client\Model\RunCalibrationHttpRequest
...
try {
    $result = $apiInstance->runCalibration($tenant_id, $project_id, $dataset_id, $version_id, $run_calibration_http_request, $authorization, $x_beater_api_key, $x_beater_project_id, $x_beater_environment_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CalibrationsApi->runCalibration: ', $e->getMessage(), PHP_EOL;
}
```
...
| **run_calibration_http_request** | [**\Beater\Client\Model\RunCalibrationHttpRequest**](../Model/RunCalibrationHttpRequest.md)|  | |
...
[**\Beater\Client\Model\CalibrationReport**](../Model/CalibrationReport.md)
